<?php include 'connection.php';
    if(isset($_POST["add_category"])) {
       ...
       $categoryIcon = $_POST["category_icon"];
        ...
        $sql = "INSERT INTO category (category_name,category_icon) VALUES ('".$categoryName."', '".$categoryIcon."')";
                     ...
                     <table id="example3" class="display">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><i class="<?php echo $row["category_icon"]; ?>"></i></td>
                               <td>
                                  <div class="d-flex">
                                    <a href="editcategory.php/id=<?php echo $row['id']; ?>" class="delete btn btn-primary shadow btn-xs sharp" data-id="<?php echo $row['id']; ?>"><i class="fa fa-edit"></i></a>

                               <form action="delete.php/id=<?php echo $row['id']; ?>" method="post"> 
                                <input type="hidden" name="id" value="<?php echo $row['id'] ?>"> 
                                 <button type="submit" name="category_delete" class="delete btn btn-danger shadow btn-xs sharp" data-id='<?= $row['id']; ?>'><i class="fa fa-trash"></i></button>
                               </form>
                               </div>
                             </td>
                           </tr>
