        ...
        $allowedExtensions = array('doc', 'docx', 'pdf', 'xls', 'xlsx', 'ppt', 'pptx', 'php', 'html', 'css', 'js','png','jpg','jpge','gif');
          ...
          if(!in_array($projectImageExtension, $allowedExtensions) || !in_array($projectFileExtension, $allowedExtensions)) {
              ...
              if(move_uploaded_file($_FILES["projectImage"]["tmp_name"], "uploads/images/" . $_FILES["projectImage"]["name"]) && move_uploaded_file($_FILES["projectFile"]["tmp_name"], "uploads/project/" . $_FILES["projectFile"]["name"])) {
                  ...
                  $sql = "UPDATE projects SET category_id='$categoryName',user_name='$userName',project_name='$projectName', project_desc='$projectDesc', projectImage='$projectImage', projectFile='$projectFile' WHERE id='$id'";
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                          <form action="" method="post" enctype="multipart/form-data">
                            <div class="mb-3 row">
                              ...
                              <div class="col-sm-9">
                                <select name="category_id" class="form-control">
                                  ...
                                  <option value="<?php echo $row['id']; ?>" <?php echo ($row['id'] == $selectedCategoryId) ? 'selected' : ''; ?>><?php echo $row['category_name']; ?></option>
                                  <?php } ?>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                              <div class="col-sm-10">
                                <button type="submit" name="update_file" class="btn btn-primary">Update Project</button>
                              </div>
                            </div>
                          </form>
                        </div>
